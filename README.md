...
| **Guardrail taxonomy** | *What* the bot may say, must hand off, must never state | Governed policy | 🚧 Stub — [`docs/guardrails/`](docs/guardrails/) |
...
│   ├── guardrails/
│   │   └── guardrail-taxonomy.md          ← STUB: what may be said / handed off / never said
│   ├── knowledge-base/
...
- [ ] Fill in the **guardrail taxonomy** from governed policy (`docs/guardrails/guardrail-taxonomy.md`).
